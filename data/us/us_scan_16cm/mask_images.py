...
def add_black_borders(input_folder, output_folder):
    ...
    for filename in os.listdir(input_folder):
        ...
        try:
            ...
            img[:, 0:200] = 0  # Rettangolo sinistro
            img[:, 1720:1920] = 0  # Rettangolo destro
            img[0:100,:] = 0 # Rettangolo superiore
            img[1040:1080,310:400] = 0 # Rettangolo inferiore
...
input_folder = "/home/ars_control/Desktop/pcnl/us_scans/us_scan_16cm/original_images"  # Cartella con le immagini originali
output_folder = "/home/ars_control/Desktop/pcnl/us_scans/us_scan_16cm/masked_images"  # Cartella per salvare le immagini modificate
